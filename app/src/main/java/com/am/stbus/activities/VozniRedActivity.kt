...
import com.am.stbus.fragments.VozniRedFragment
...
private var TAG = VozniRedActivity::class.java.simpleName
...
class VozniRedActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btn_error.setOnClickListener(onClickBtnError)

        GetVozniRed(this).execute(fetchUrl, naziv)
    }

    private var onClickBtnError: View.OnClickListener = View.OnClickListener {
        Utils().reportIssue(this, naziv)
    }
